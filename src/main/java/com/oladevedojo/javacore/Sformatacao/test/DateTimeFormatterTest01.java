...
public class DateTimeFormatterTest01 {
    public static void main(String[] args) {
        ...
        LocalDateTime parse4 = LocalDateTime.parse("2022-09-25T12:34:43.18178", DateTimeFormatter.ISO_DATE_TIME);
        ...
        LocalDate parseGR = LocalDate.parse("25.September.2022", formatterGR);
